...
resource "aws_eip" "nat_1" {
  ...
  depends_on = [
    aws_internet_gateway.url_shortener_igw
  ]

  tags = {
    Name = "URL Shortener NAT EIP 1"
  }
}
...
resource "aws_nat_gateway" "nat_2" {
  ...
  tags = {
    Name = "URL Shortener NAT Gateway 2"
  }
}
resource "aws_route_table" "private_app_1" {
  ...
  tags = {
    Name = "URL Shortener Private App Route Table 1"
  }
}
...
resource "aws_route_table" "private_app_2" {
  ...
  tags = {
    Name = "URL Shortener Private App Route Table 2"
  }
}
